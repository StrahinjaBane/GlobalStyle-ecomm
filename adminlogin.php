    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                    ...
                    <form role="form" action="adminlogin.inc.php" method="post">
                        
                        <div class="form-group">
                            <input type="text" name="adminuid" id="admin" class="form-control input-sm" placeholder="User name" style="margin:5px 5px 5px">
                            <input type="password" name="adminpwd" id="adminpassword" class="form-control input-sm" placeholder="Password" style="margin:5px 5px 5px">
                        </div>

                                                
                        <input type="submit" name="adminlogin-button" value="Login" class="btn btn-info btn-block">
