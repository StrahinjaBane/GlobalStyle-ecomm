    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                    ...
                    <form role="form" action="register.inc.php" method="post">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                        <input type="text" name="uid" id="user_name" class="form-control input-sm" placeholder="User Name">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <input type="password" name="pwd" id="password" class="form-control input-sm" placeholder="Password">
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <input type="password" name="pwd-repeat" id="password_confirmation" class="form-control input-sm" placeholder="Confirm Password">
                                </div>
                            </div>
                        </div>
                        
                        <input type="submit" name="submit-button" value="Register" class="btn btn-info btn-block">
                        <div class="extra-form-container" style="text-align: center; margin-top: 20px;">
                            <div class="col-md-12">
                            
                            <p>forgot your password?<a href="#">Click here</a></p>
                            <p>already a user?<a href="login.php">Click here</a></p>
